...
block1 = char_block(embedded, [128, 256], filter_length=[3, 3], subsample=[1, 1], pool_length=2)
block2 = char_block(embedded, [128, 256], filter_length=[5, 3], subsample=[2, 1], pool_length=2)
block3 = char_block(embedded, [246, 512], filter_length=[7, 3], subsample=[2, 1])
...
lstm_h = 80
forwards = LSTM(lstm_h, return_sequences=False, dropout_W=0.3, dropout_U=0.2,
                consume_less='gpu')(encoded)
backwards = LSTM(lstm_h, return_sequences=False, dropout_W=0.3, dropout_U=0.2,
